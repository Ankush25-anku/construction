            ...
            >
              <div className="single-footer-widget">
                ...
                <ul className="list-items">
                  ...
                  <li><a href="contact.html">Opportunity</a></li>
            ...
            >
              <div className="single-footer-widget">
                ...
                <ul className="list-items">
                  ...
                  <li><a href="service.html">Art generate</a></li>
                  <li><a href="service.html">Face swap</a></li>
                  <li><a href="service.html">Interior design</a></li>
                  <li><a href="service.html">Face swap</a></li>
                  <li><a href="service.html">Mockup create</a></li>
                </ul>
              </div>
            </div>
